...
def process_data(args):
    ...
    save_file(save_dir, args.train_prefix, train_utter_dialogues, train_action_dialogues)
    save_file(save_dir, args.valid_prefix, valid_utter_dialogues, valid_action_dialogues)
    save_file(save_dir, args.test_prefix, test_utter_dialogues, test_action_dialogues)
